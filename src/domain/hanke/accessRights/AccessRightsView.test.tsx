...
test('Renders correct information', async () => {
  ...
  expect(screen.getByTestId('roolit-7')).toHaveTextContent('RakennuttajaToteuttaja');
...
test('Sorting by users role works', async () => {
  ...
  expect(screen.getByTestId('roolit-2')).toHaveTextContent('');
  ...
  expect(screen.getByTestId('roolit-8')).toHaveTextContent('Omistaja');
  expect(screen.getByTestId('roolit-9')).toHaveTextContent('Rakennuttaja');

  fireEvent.click(screen.getByTestId('hds-table-sorting-header-roolit'));

  expect(screen.getByTestId('roolit-0')).toHaveTextContent('Toteuttaja');
  expect(screen.getByTestId('roolit-1')).toHaveTextContent('RakennuttajaToteuttaja');
  expect(screen.getByTestId('roolit-2')).toHaveTextContent('Rakennuttaja');
  expect(screen.getByTestId('roolit-3')).toHaveTextContent('Omistaja');
  ...
  expect(screen.getByTestId('roolit-9')).toHaveTextContent('');
});
