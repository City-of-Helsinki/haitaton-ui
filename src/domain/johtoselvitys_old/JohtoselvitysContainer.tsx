        ...
        <div className={styles.navPrev}>
          <Button
            ...
            onClick={() => {
              // TODO: HAI-1165
              // TODO: HAI-1166
              navigate(`/fi/johtoselvityshakemusvanha${previousPath}`); // TODO: localized links
            }}
          >
            Edellinen
          </Button>
        ...
        <div className={styles.navNext}>
          <Button
            ...
            onClick={() => {
              // TODO: HAI-1165
              // TODO: HAI-1166
              navigate(`/fi/johtoselvityshakemusvanha${nextPath}`); // TODO: localized links
            }}
          >
            Seuraava
          </Button>
                      ...
                      <div className={styles.pagination}>
                        <FormPagination
                          ...
                          onPageChange={(pageIndex) =>
                            navigate(`/fi/johtoselvityshakemusvanha${formSteps[pageIndex].path}`)
                          }
                        />
                      </div>
